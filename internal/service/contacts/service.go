...
// ContactService handles alert contact management.
...
func (s *contactService) CreateTelegramAlertContact(
	ctx context.Context,
...
func (s *contactService) UpdateAlertContact(
	ctx context.Context,
	...
	if usr.Login != contact.User.Login {
		return errors.Join(service.ErrPermissionDenied, err)
	}
...
func (s *contactService) DeleteAlertContact(ctx context.Context, contactID uuid.UUID) error {
...
func (s *contactService) EnableAlertContact(ctx context.Context, contactID uuid.UUID) error {
...
func (s *contactService) DisableAlertContact(ctx context.Context, contactID uuid.UUID) error {
